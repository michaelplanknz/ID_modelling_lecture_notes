...
1. After an individual has tested positive, their likelihood of transmitting is reduced by a factor $c_\mathrm{iso}\in[0,1]$ representing the effects of case isolation ($c_\mathrm{iso}=0$ corresponds to perfect case isolation; larger values of $c_\mathrm{iso}$ correspond to less effective case isolation).
