...
In applications of vaccine modelling, age is often a crucial variable either because people typically get vaccinated at a certain age (e.g. childhood immunisations), or because there is strong age-dependence in disease severity (and therefore in the benefit of vaccination). We will cover age-structured models in Topic 11, but for now we focus on the simple homogeneous population case.
